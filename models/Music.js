...
const VALID_SECTIONS = [
  'Processional', 'Ceremony', 'Cocktail Hour',
  'First Dance',  'Reception', 'Last Dance',
];

class Music {
  static get SECTIONS() { return VALID_SECTIONS; }
   ...
   */
  static async create(userId, { section, trackId, trackName, artistName, artworkUrl, previewUrl }) {
    const { rows } = await query(
      `INSERT INTO music_tracks
       ...
       RETURNING *`,
      [userId, section, trackId, trackName,
       artistName  || null,
       artworkUrl  || null,
       previewUrl  || null],
    );
